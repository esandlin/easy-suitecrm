...
$mod_strings = array(
    ...
    'LBL_SYSOPTS_2' => 'Quel type de base de données sera utilisé pour l\'instance Easy-SuiteCRM que vous êtes sur le point d\'installer?',
    'LBL_SYSOPTS_DB' => 'Spécifiez le type de base de données',
    ...
    'ERR_ADMIN_USER_NAME_BLANK' => 'Indiquez le nom d\'utilisateur de l\'utilisateur administrateur Easy-SuiteCRM. ',
    'ERR_ADMIN_PASS_BLANK' => 'Fournissez le mot de passe de l\'utilisateur administrateur Easy-SuiteCRM. ',
    'ERR_CHECKSYS' => 'Des erreurs ont été détectées lors du contrôle de compatibilité. Pour que votre installation Easy-SuiteCRM fonctionne correctement, veuillez prendre les mesures appropriées pour résoudre les problèmes énumérés ci-dessous et appuyez sur le bouton de vérification ou essayez de réinstaller.',
    'ERR_CHECKSYS_CALL_TIME' => 'Autoriser la référence de passage de temps d\'appel est activé (il devrait être défini sur Désactivé dans php.ini)',
    'ERR_CHECKSYS_CURL' => 'Introuvable: Easy-SuiteCRM Scheduler s\'exécutera avec des fonctionnalités limitées.',
    'ERR_CHECKSYS_IMAP' => 'Introuvable: InboundEmail et Campaigns (Email) nécessitent les bibliothèques IMAP. Aucun ne sera fonctionnel.',
    'ERR_CHECKSYS_MEM_LIMIT_1' => ' (Réglez ceci sur ',
    'ERR_CHECKSYS_MEM_LIMIT_2' => 'M ou plus dans votre fichier php.ini)',
    'ERR_CHECKSYS_NOT_WRITABLE' => 'Avertissement: non accessible en écriture',
    'ERR_CHECKSYS_PHP_INVALID_VER' => "Votre version de PHP n'est pas prise en charge par Easy-SuiteCRM. Vous devrez installer une version compatible avec l'application Easy-SuiteCRM. Veuillez consulter la matrice de compatibilité dans les notes de publication pour connaître les versions PHP prises en charge. Votre version est ",
    'ERR_CHECKSYS_IIS_INVALID_VER' => "Votre version d'IIS n'est pas prise en charge par Easy-SuiteCRM. Vous devrez installer une version compatible avec l'application Easy-SuiteCRM. Veuillez consulter la matrice de compatibilité dans les notes de publication pour connaître les versions prises en charge par IIS. Votre version est " ,
    'ERR_CHECKSYS_FASTCGI' => "Nous détectons que vous n'utilisez pas de mappage de gestionnaire FastCGI pour PHP. Vous devrez installer / configurer une version compatible avec l'application Easy-SuiteCRM. Veuillez consulter la matrice de compatibilité des notes de version pour connaître les versions prises en charge. Veuillez consulter <a href=\"http://www.iis.net/php/\" target=\"_blank\"> http://www.iis.net/php/ </a> pour plus de détails.",
    'ERR_CHECKSYS_FASTCGI_LOGGING' => 'Pour une expérience optimale avec IIS/FastCGI sapi, définissez fastcgi.logging sur 0 dans votre fichier php.ini.',
    'LBL_DB_UNAVAILABLE' => 'Base de données indisponible',
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => "Le support de base de données n'a pas été trouvé. Assurez-vous de disposer des pilotes nécessaires pour l’un des types de bases de données pris en charge suivants: MySQL ou MS SQLServer. Vous devrez peut-être supprimer le commentaire de l'extension du fichier php.ini ou recompiler avec le bon fichier binaire, selon votre version de PHP. Veuillez vous référer à votre manuel PHP pour plus d'informations sur la façon d'activer le support de base de données.",
    'LBL_CHECKSYS_XML_NOT_AVAILABLE' => "Les fonctions associées aux bibliothèques d'analyseur XML requises par l'application Easy-SuiteCRM sont introuvables. Vous devrez peut-être supprimer le commentaire de l'extension dans le fichier php.ini ou recompiler avec le bon fichier binaire, selon votre version de PHP. Veuillez vous référer à votre manuel PHP pour plus d'informations.",
    'ERR_CHECKSYS_MBSTRING' => "Les fonctions associées à l'extension PHP multibyte Strings (mbstring) nécessaires à l'application Easy-SuiteCRM sont introuvables. <br/> <br/> Généralement, le module mbstring n'est pas activé par défaut en PHP et doit être activé avec --enable-mbstring lorsque le binaire PHP est créé. Veuillez vous référer à votre manuel PHP pour plus d'informations sur la manière d'activer le support mbstring.",
    'ERR_CHECKSYS_CONFIG_NOT_WRITABLE' => 'Le fichier de configuration existe mais n\'est pas accessible en écriture. Veuillez prendre les mesures nécessaires pour rendre le fichier accessible en écriture. Selon votre système d\'exploitation, vous devrez peut-être modifier les autorisations en exécutant chmod 766 ou cliquer avec le bouton droit de la souris sur le nom du fichier pour accéder aux propriétés et décocher l\'option de lecture seule.',
    'ERR_CHECKSYS_CONFIG_OVERRIDE_NOT_WRITABLE' => "Le fichier de remplacement de configuration existe mais n'est pas accessible en écriture. Veuillez prendre les mesures nécessaires pour rendre le fichier accessible en écriture. Selon votre système d'exploitation, vous devrez peut-être modifier les autorisations en exécutant chmod 766 ou cliquer avec le bouton droit de la souris sur le nom du fichier pour accéder aux propriétés et décocher l'option de lecture seule.",
    'ERR_CHECKSYS_CUSTOM_NOT_WRITABLE' => 'Le répertoire personnalisé existe mais n\'est pas accessible en écriture. Vous devrez peut-être modifier les autorisations sur ce dernier (chmod 766) ou cliquer dessus avec le bouton droit de la souris et décocher l\'option de lecture seule, selon votre système d\'exploitation. Veuillez prendre les mesures nécessaires pour rendre le fichier accessible en écriture.',
    'ERR_CHECKSYS_FILES_NOT_WRITABLE' => "Les fichiers ou répertoires répertoriés ci-dessous ne sont pas inscriptibles ou sont manquants et ne peuvent pas être créés. Selon votre système d'exploitation, vous devrez peut-être modifier les autorisations sur les fichiers ou le répertoire parent (chmod 755), ou cliquer avec le bouton droit de la souris sur le répertoire parent, décocher l'option 'lecture seule' et l'appliquer à tous les sous-dossiers.",
    'LBL_CHECKSYS_OVERRIDE_CONFIG' => 'Priorité de configuration',
    'ERR_CHECKSYS_SAFE_MODE' => 'Le mode sans échec est activé (vous pouvez souhaiter le désactiver dans php.ini)',
    'ERR_CHECKSYS_ZLIB' => 'Support ZLib introuvable: SuiteCRM offre des avantages énormes en termes de performances avec la compression zlib.',
    'ERR_CHECKSYS_ZIP' => 'Support ZIP introuvable: SuiteCRM a besoin du support ZIP pour traiter les fichiers compressés.',
    'ERR_CHECKSYS_PCRE' => 'Bibliothèque PCRE introuvable: SuiteCRM a besoin de la bibliothèque PCRE pour traiter le style Perl de correspondance du modèle d\'expression régulière',
    'ERR_CHECKSYS_PCRE_VER' => 'Version de la bibliothèque PCRE: SuiteCRM a besoin de la bibliothèque PCRE 7.0 ou supérieure pour traiter le style Perl de correspondance de modèle d\'expression régulière.',
    'ERR_DB_ADMIN' => "Le nom d'utilisateur et / ou le mot de passe de l'administrateur de la base de données fourni n'est pas valide et une connexion à la base de données n'a pas pu être établie. Veuillez entrer un nom d'utilisateur et un mot de passe valides. (Erreur: ",
    'ERR_DB_ADMIN_MSSQL' => "Le nom d'utilisateur et / ou le mot de passe de l'administrateur de la base de données fourni n'est pas valide et une connexion à la base de données n'a pas pu être établie. Veuillez entrer un nom d'utilisateur et un mot de passe valides.",
    'ERR_DB_EXISTS_NOT' => 'La base de données spécifiée n\'existe pas.',
    'ERR_DB_EXISTS_WITH_CONFIG' => "La base de données existe déjà avec les données de configuration. Pour exécuter une installation avec la base de données choisie, veuillez réexécuter l’installation et choisir: \"Supprimer et recréer les tables SuiteCRM existantes?\". Pour mettre à niveau, utilisez l'assistant de mise à niveau de la console d'administration. Veuillez consulter la documentation de mise à niveau située <a href="https://suitecrm.com/wiki/index.php/Upgrade" target="_new"> ici </a>.",
    'ERR_DB_EXISTS' => 'Le nom de base de données fourni existe déjà - vous ne pouvez pas en créer un autre du même nom.',
    'ERR_DB_EXISTS_PROCEED' => "Le nom de base de données fourni existe déjà. Vous pouvez <br> 1. appuyez sur le bouton Précédent et choisissez un nouveau nom de base de données <br> 2. Cliquez sur Suivant et continuez, mais toutes les tables existantes de cette base de données seront supprimées. <strong> Cela signifie que vos tables et vos données seront époustouflées. </strong>",
    'ERR_DB_HOSTNAME' => 'Le nom d\'hôte ne peut pas être vide.',
    'ERR_DB_INVALID' => 'Type de base de données non valide sélectionné.',
    'ERR_DB_LOGIN_FAILURE' => "L'hôte, le nom d'utilisateur et / ou le mot de passe de base de données fournis sont invalides et une connexion à la base de données n'a pas pu être établie. S'il vous plaît entrer un hôte valide, nom d'utilisateur et mot de passe" ,
    'ERR_DB_LOGIN_FAILURE_MYSQL' => "L'hôte, le nom d'utilisateur et / ou le mot de passe de base de données fournis sont invalides et une connexion à la base de données n'a pas pu être établie. S'il vous plaît entrer un hôte valide, nom d'utilisateur et mot de passe" ,
    'ERR_DB_LOGIN_FAILURE_MSSQL' => "L'hôte, le nom d'utilisateur et / ou le mot de passe de base de données fournis sont invalides et une connexion à la base de données n'a pas pu être établie. S'il vous plaît entrer un hôte valide, nom d'utilisateur et mot de passe ",
    'ERR_DB_MYSQL_VERSION' => "Votre version de MySQL (% s) n'est pas prise en charge par SuiteCRM. Vous devrez installer une version compatible avec l'application SuiteCRM. Veuillez consulter la matrice de compatibilité dans les notes de publication pour connaître les versions prises en charge par MySQL.",
    'ERR_DB_NAME' => 'Le nom de la base de données ne peut pas être vide.',
    'ERR_DB_MYSQL_DB_NAME_INVALID' => "Le nom de la base de données ne peut pas contenir '\\', '/' ou '.'",
    'ERR_DB_MSSQL_DB_NAME_INVALID' => "Le nom de la base de données ne peut pas commencer par un nombre, '#' ou '@' et ne peut pas contenir d'espace, '\ "', \" '\ ",' * ',' / ',' \ ','? ',' : ',' <','> ',' & ','! 'ou' - '",
    'ERR_DB_OCI8_DB_NAME_INVALID' => "Le nom de la base de données ne peut contenir que des caractères alphanumériques et les symboles '#', '_' ou '$'",
    'ERR_DB_PASSWORD' => "Les mots de passe fournis pour l'administrateur de la base de données SuiteCRM ne correspondent pas. Veuillez ressaisir les mêmes mots de passe dans les champs de mot de passe.",
    'ERR_DB_PRIV_USER' => "Indiquez un nom d'utilisateur d'administrateur de base de données. L'utilisateur est requis pour la connexion initiale à la base de données.",
    'ERR_DB_USER_EXISTS' => "Le nom d'utilisateur pour l'utilisateur de la base de données SuiteCRM existe déjà. Veuillez entrer un nouveau nom d'utilisateur.",
    'ERR_DB_USER' => "Entrez un nom d'utilisateur pour l'administrateur de la base de données SuiteCRM.",
    'ERR_DBCONF_VALIDATION' => 'Veuillez corriger les erreurs suivantes avant de continuer:',
    'ERR_DBCONF_PASSWORD_MISMATCH' => "Les mots de passe fournis pour l'utilisateur de la base de données SuiteCRM ne correspondent pas. Veuillez ressaisir les mêmes mots de passe dans les champs de mot de passe.",
    'ERR_ERROR_GENERAL' => 'Les erreurs suivantes ont été rencontrées:',
    'ERR_LANG_CANNOT_DELETE_FILE' => 'Impossible de supprimer le fichier: ',
    'ERR_LANG_MISSING_FILE' => 'Impossible de trouver le fichier: ',
    'ERR_LANG_NO_LANG_FILE' => 'Aucun fichier de pack de langue trouvé dans le répertoire include / language: ',
    'ERR_LANG_UPLOAD_1' => 'Il y avait un problème avec votre téléchargement. Veuillez réessayer.',
    'ERR_LANG_UPLOAD_2' => 'Les modules linguistiques doivent être des archives ZIP.',
    'ERR_LANG_UPLOAD_3' => "PHP n'a pas pu déplacer le fichier temporaire dans le répertoire de mise à niveau.",
    'ERR_LOG_DIRECTORY_NOT_EXISTS' => 'Le répertoire de journal fourni n\'est pas un répertoire valide.',
    'ERR_LOG_DIRECTORY_NOT_WRITABLE' => 'Le répertoire de journal fourni n\'est pas un répertoire accessible en écriture.',
    'ERR_NO_DIRECT_SCRIPT' => 'Impossible de traiter le script directement.',
    'ERR_NO_SINGLE_QUOTE' => 'Impossible d\'utiliser le guillemet simple pour',
    'ERR_PASSWORD_MISMATCH' => 'Les mots de passe fournis pour l\'utilisateur administrateur SuiteCRM ne correspondent pas. Veuillez ressaisir les mêmes mots de passe dans les champs de mot de passe.',
    'ERR_PERFORM_CONFIG_PHP_1' => 'Impossible d\'écrire dans le fichier <span class = stop> config.php </ span>.',
    'ERR_PERFORM_CONFIG_PHP_2' => "Vous pouvez continuer cette installation en créant manuellement le fichier config.php et en collant les informations de configuration ci-dessous dans le fichier config.php. Cependant, vous <strong> devez </ strong> créer le fichier config.php avant de passer à l'étape suivante.",
    'ERR_PERFORM_CONFIG_PHP_3' => 'Avez-vous pensé à créer le fichier config.php?',
    'ERR_PERFORM_CONFIG_PHP_4' => "Avertissement: Impossible d'écrire dans le fichier config.php. S'il vous plaît assurez-vous qu'il existe.",
    'ERR_PERFORM_HTACCESS_1' => 'Impossible d\'écrire au ',
    'ERR_PERFORM_HTACCESS_2' => ' fichier.',
    'ERR_PERFORM_HTACCESS_3' => 'Si vous souhaitez que votre fichier journal ne soit pas accessible via un navigateur, créez un fichier .htaccess dans votre répertoire de journaux avec la ligne:',
    ...
    'ERR_URL_BLANK' => 'Provide the base URL for the Easy-SuiteCRM instance.',
    ...
    'ERROR_VERSION_INCOMPATIBLE' => 'The uploaded file is not compatible with this version of Easy-SuiteCRM: ',
    ...
    'LBL_CHECKSYS_CONFIG' => 'Writable Easy-SuiteCRM Configuration File (config.php)',
    ...
    'LBL_DBCONF_DB_PASSWORD' => 'Easy-SuiteCRM Database User Password',
    'LBL_DBCONF_DB_PASSWORD2' => 'Re-enter Easy-SuiteCRM Database User Password',
    'LBL_DBCONF_DB_USER' => 'Easy-SuiteCRM Database User',
    'LBL_DBCONF_SUITE_DB_USER' => 'Easy-SuiteCRM Database User',
    ...
    'LBL_DBCONFIG_SECURITY' => 'For security purposes, you can specify an exclusive database user to connect to the Easy-SuiteCRM database. This user must be able to write, update and retrieve data on the Easy-SuiteCRM database that will be created for this instance. This user can be the database administrator specified above, or you can provide new or existing database user information.',
    ...
    'LBL_DISABLED_HELP_1' => 'For installation help, please visit the Easy-SuiteCRM',
    'LBL_DISABLED_HELP_LNK' => 'https://suitecrm.com/suitecrm/forum/suite-forum',
    'LBL_DISABLED_HELP_2' => 'support forums',
    'LBL_DISABLED_TITLE_2' => 'Easy-SuiteCRM Installation has been Disabled',
    'LBL_HELP' => 'Help',
    'LBL_INSTALL' => 'Install',
    ...
    'LBL_LANG_1' => 'To use a language in Easy-SuiteCRM other than the default language (US-English), you can upload and install the language pack at this time. You will be able to upload and install language packs from within the SuiteCRM application as well. If you would like to skip this step, click Next.',
    ...
    'LBL_LAUNCHING_SILENT_INSTALL' => 'Installing Easy-SuiteCRM now. This may take up to a few minutes.',
    ...
    'LBL_LICENSE_TITLE_2' => 'Easy-SuiteCRM License',
    ...
    'LBL_STEP' => 'Step',
    'LBL_TITLE_WELCOME' => 'Welcome to the Easy-SuiteCRM ',
