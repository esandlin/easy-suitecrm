...
function getSupportedInstallLanguages()
{
    $supportedLanguages = array(
        'en_us'	=> 'English (US)','es_mx'	=> 'Spanish (Mexico)',
        'fr'	=> 'French (Standard)', 'ja'	=> 'Japanese',
        'hi'    => 'Hindi',
    );
...
if ($current_language == 'fr') {
    $my_mod_strings = $mod_strings;
    include('install/language/fr.lang.php');
    $mod_strings = sugarLangArrayMerge($mod_strings, $my_mod_strings);
}
...
if ($current_language == 'ja') {
    $my_mod_strings = $mod_strings;
    include('install/language/ja.lang.php');
    $mod_strings = sugarLangArrayMerge($mod_strings, $my_mod_strings);
}
...
if ($current_language == 'hi') {
    $my_mod_strings = $mod_strings;
    include('install/language/hi.lang.php');
    $mod_strings = sugarLangArrayMerge($mod_strings, $my_mod_strings);
}
